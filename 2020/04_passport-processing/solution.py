...
passports = [parse_passport(s) for s in passStrings if validate(parse_passport(s), True)]
valid_passports = [parse_passport(s) for s in passStrings if validate(parse_passport(s))]
