...
io = {
    ...
    "velocity": [0, 0, 0],
    "coordinates": list(
        map(int, [io_pos.group("x"), io_pos.group("y"), io_pos.group("z")])
    ),
}
...
europa = {
    ...
    "velocity": [0, 0, 0],
    "coordinates": list(
        map(int, [europa_pos.group("x"), europa_pos.group("y"), europa_pos.group("z")])
    ),
}
...
ganymede = {
    ...
    "coordinates": list(
        map(
            int,
            [ganymede_pos.group("x"), ganymede_pos.group("y"), ganymede_pos.group("z")],
        )
    ),
}
...
callisto = {
    ...
    "coordinates": list(
        map(
            int,
            [callisto_pos.group("x"), callisto_pos.group("y"), callisto_pos.group("z")],
        )
    ),
}
...
def printState(moonlist):
    for m in moonlist:
        print(
            "{}: position: {}, velocity: {} kin: {} pot: {} total: {}".format(
                m["name"],
                m["coordinates"],
                m["velocity"],
                m["kin"],
